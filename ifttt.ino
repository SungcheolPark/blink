#include <ESP8266WiFi.h> 
 ...
 String url   = "/trigger/event/with/key/cjvjqVl_rQgBUpI95LQWn4?";// Your Own Key here // = "/update?api_key=WD112D9UCJ4ZWDPR";  
 const int httpPort = 80; 
 int interval = 5000; 
 
 
 const char* ssid = "iPhone";   // Your own ssid here 
 const char* password = "01046175470";  // Your own password here 
